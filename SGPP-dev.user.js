...
(function (ModuleDefinition) {
    ...
    var MarkComments = (function () {
        function MarkComments() {
            this.style = ".endless_new .comment__parent .comment__summary, .endless_new > .comment__child{}" + ".endless_not_new .comment__parent .comment__summary, .endless_not_new > .comment__child{}" + ".endless_not_new:hover .comment__parent .comment__summary, .endless_not_new:hover > .comment__child{}" + ".endless_badge_new, .endless_badge_new_child {border-radius: 4px; margin-left:5px; padding: 1px 5px; background-color: #C50000;text-shadow: none;color: white; font-weight: bold;}" + ".endless_badge_new_child { display: none; }" + ".comment--collapsed .endless_badge_new_child { display: block; }\n" + ".table__row-outer-wrap .markcomments_controls { display: none; }\n" + ".table__row-outer-wrap:hover .markcomments_controls { display: inline; }" + ".markcomments_controls i { opacity: 0; cursor: pointer; position: relative; left: -13px ; top: -1px; color: #465670; font-size: 12px }\n" + ".markcomments_controls i:hover { opacity: 1; }";
        }
